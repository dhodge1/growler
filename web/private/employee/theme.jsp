            ...
            <div class="row">
				...
				<%
                    ...
                    if (themes == null || themes.size() == 0) {
                        out.print("<h2 class=bordered><img style=\"padding-bottom:0;padding-left:0;width:200px;\" src='../../images/Techtoberfest2013small.png'/><span class=\"titlespan\">Themes - Drag & Drop Themes to Rank Them</span></h2>");
                        out.print("<a href=\"nondragtheme.jsp\">Non Drag and Drop Themes</a><br/>");
                    } else { //If we got themes, we let the user see them
                        out.print("<h2 class=bordered><img style=\"padding-bottom:0;padding-left:0;width:200px;\" src='../../images/Techtoberfest2013small.png'/><span class=\"titlespan\">Your Theme Ranks</span></h2>");
                    }
                %>
