        ...
        <div class="container-fixed mediumBottomMargin">
            ...
            <div class="mediumBottomMargin row">
                <p class="feedbackMessage-warning">You have already submitted a ranking for your preferred speakers.  In order to submit a different ranking, you must reset your previous one.
                    <% out.print("<a href='" +  request.getContextPath() + "/action/removeSpeakerRanks.jsp?return=drag&id=" + user + "'>Reset your previous ranking now.</a>");%>
                </p>
            </div>
            <% } //end if  %>
            ...
            <div class="row mediumBottomMargin">
                <h2 class='bordered mediumBottomMargin'><img style='padding-bottom:0;padding-left:0;' src='${pageContext.request.contextPath}/images/Techtoberfest2013small.png'/><span class='titlespan'>Which speakers are you most interested in?</span></h2>
                <span>Please drag and drop the speakers you are most interested in and rank them 1-10. If desired, you can provide a ranking for fewer than 10 speakers. Once your ranking has been submitted, you cannot submit another unless you choose to reset/clear your previous one.  <br/></span>
                ...
                <form action='../../action/processSpeakerRanking.jsp'>
                    ...
                    <div class="form-actions smallBottomMargin"><input id='send' type='submit' value='Submit My Ranking' class='button button-primary'/><a href=../../home>Cancel</a></div>
