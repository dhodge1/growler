<%-- 
    Document   : likedSessions
    Created on : Mar 30, 2014, 2:24:29 AM
    Author     : David
--%>
...
<html class="no-js" lang="en"> <!--<![endif]-->
    <head>
        ...
        <title>Personal Session Schedule</title><!-- Title -->
    ...
    <body id="growler1">  
        ...
        <%
            ...
            ArrayList<Session> sessions = sp.getThisYearLikedActiveSessions(year, " order by session_date, start_time, name ", true, user);
        ...
        <div class="container-fixed">
            ...
            <div class="row mediumBottomMargin">
                <h1>2014 Personalized Session Schedule</h1> <!-- change to 2014-->
            </div>
            <div class="row mediumBottomMargin" style="border:1px dotted #ddd"></div>
            <div class="row largeBottomMargin">
                <span>Below is your personalized session schedule for this years Techtoberfest!</span>
            </div>
            <div class="row mediumBottomMargin">
