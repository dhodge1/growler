<%-- 
    Document   : overallSurveySubmitted
    Created on : Mar 13, 2014, 10:55:59 PM
    Author     : David
--%>
...
<!--[if gt IE 8]><!--> <html class="no-js" lang="en"> <!--<![endif]-->
    <head>
        ...
        <title>Overall Survey Submission</title>
        ...
        <div class="container-fixed largeBottomMargin">
            ...
            <div class="row">
                <ul class="breadcrumb">
                    ...
                    <li class='ieFix'>Overall Survey Submitted</li>
                </ul>
            </div>
            <div class="row">
            ...
            <div class="row mediumBottomMargin">
                <h1>Overall Survey Submission</h1>
            </div>
            <div class="row mediumBottomMargin" style="border:1px dotted #ddd"></div>
            <div class="row">
                <span>The Techtoberfest committee thanks you for your feedback!</span>
            </div>
