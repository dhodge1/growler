...
%>
        ...
        <div class="container-fixed mediumBottomMargin">
            ...
            <div class="row mediumBottomMargin">
                <h2 class="bordered"><img style="padding-bottom:0;padding-left:0;" src='${pageContext.request.contextPath}/images/Techtoberfest2013small.png'/><span style="padding-left:12px;">Administration Details</span></h2>
            </div>
            <div class="row">
                <h3>Themes Menu</h3>
