    ...
    <body id="growler1">
        ...
        <div class="container-fixed">
            ...
            <div class="row smallBottomMargin">
                <h2 class="bordered"><img style="padding-bottom:0;padding-left:0;" src='http://sni-techtoberfest.elasticbeanstalk.com/images/Techtoberfest2013small.png'/><span style="padding-left: 12px;">Schedule Details</span><a href="../../../private/employee/admin/sessionScheduler.jsp" class="pullRight button button-primary">Schedule Sessions</a></h2>
            </div>
            <div class='row smallBottomMargin'>
