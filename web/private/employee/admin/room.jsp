...
<html class="no-js" lang="en"> <!--<![endif]-->
    ...
    <body id="growler1">
        ...
        <div class="container-fixed">
            ...
            <div class="row">
                <div class="span8">
                    <h2 class="bordered"><img style="padding-bottom:0;padding-left:0;" src='http://sni-techtoberfest.elasticbeanstalk.com/images/Techtoberfest2013small.png'/><span class="titlespan">Rooms</span></h2>
                </div>
            </div>
            <br/>
            <div class="row">
