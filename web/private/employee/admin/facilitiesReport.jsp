<%-- 
    Document   : facilitiesReport
    Created on : Mar 23, 2014, 12:35:19 AM
    Author     : David
--%>
        ...
        <div class="container-fixed largeBottomMargin">
            ...
            <div class="row">
                <ul class="breadcrumb">
                    ...
                    <li class='ieFix'>Facilities Report</li>
                </ul>
            </div>
            <div class="list">
                <div class="row mediumBottomMargin">
                    <h1>Facility Ratings by Room</h1>
                </div>
                <div class="row mediumBottomMargin" style="border:1px dotted #ddd"></div>
                <div class="row largeBottomMargin">
                    <h3>The table below displays a listing of rated facilities and attendance by room.</h3>
                </div>
                        ...
                        <table class="table table-alternatingRow table-border table-columnBorder table-rowBorder">
                            ...
                            <tbody>
                                <%
                                        ...
                                        ArrayList<FacilityReport> questions = rg.generateFacilityReport();
                                        if (questions.size() == 0) {
                                            out.print("<tr>");
                                            out.print("<td>");
                                        ...
                                        for (int i = 0; i < questions.size(); i++) {
                                            ...
                                            out.print("</td>");
                                            out.print("<td>");
                                            out.print(questions.get(i).getAvgAttendance());
                                            out.print("</td>");
                                            out.print("<td>");
                                            out.print(questions.get(i).getTotalAttendance());
                                            out.print("</td>");
                                            out.print("<td>");
                                            out.print(questions.get(i).getAvgRating());
                                            out.print("</td>");
                                            out.print("</tr>");
                                        }
                                %>
