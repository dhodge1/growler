<%-- 
    Document   : emailBySurvey
                 ...
                 that submitted a survey. The eBySurvey.jsp is the action 
                 jsp of this page and it also locates in the admin folder.
        ...
        <div class="container-fixed">  
           ...
           <div class="row">         
             <ul class="breadcrumb">
               ...
               <li class='ieFix'>Participants "submitted" survey</li>
             </ul>
           </div>
