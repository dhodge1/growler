<%-- 
    Document   : presentationReport
    Created on : Jun 12, 2013, 9:03:31 AM
    Author     : 162107
--%>
...
<!--[if gt IE 8]><!--> <html class="no-js" lang="en"> <!--<![endif]-->
    <head>
        ...
        <title>Best Presentation Skills Report</title>
        ...
        <div class="container-fixed">
            ...
            <div class="row">
                <ul class="breadcrumb">
                    ...
                    <li class='ieFix'>Best Presentation Skills Report</li>
                </ul>
            </div>
            <div class="row mediumBottomMargin">
                <h1>Best Presentation Skills Report</h1>
            </div>
            <div class="row mediumBottomMargin" style="border:1px dotted #ddd"></div>
            <div class="row largeBottomMargin">
                <h3>The table below displays a detailed listing of all speakers employees felt had above average presentation skills.</h3>
            </div>
                    ...
                    <table class="table table-alternatingRow table-border table-columnBorder table-rowBorder">
                        ...
                        <tbody>
                            <%
                                ...
                                ArrayList<QuestionReport> questions = rg.generateRankingsReport(3);
                                if (questions.size() == 0) {
                                    out.print("<tr>");
                                    out.print("<td>");
