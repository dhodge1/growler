    ...
    <body id="growler1">
        ...
        <div class="container-fixed">
            ...
            <div class="row">
                    ...
                    <h2 class="bordered"><img style="padding-bottom:0;padding-left:0;" src='http://sni-techtoberfest.elasticbeanstalk.com/images/Techtoberfest2013small.png'/><span class="titlespan">Best Presentation Skills</span></h2>
            ...
            <div class="row">
                    ...
                    <table class="table table-alternatingRow table-border table-columnBorder table-rowBorder">
                        ...
                        <%  ReportGenerator rg = new ReportGenerator();
                            ArrayList<QuestionReport> qr = rg.generateRankingsReport(3);
