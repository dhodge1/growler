    ...
    <body id="growler1">
        ...
        <div class="container-fixed">
            ...
            <div class="row">
                    ...
                    <h2 class="bordered"><img style="padding-bottom:0;padding-left:0;" src='${pageContext.request.contextPath}/images/Techtoberfest2013small.png'/><span style="padding-left: 12px;">Session Scheduler Tool</span></h2>
            ...
            <div class="row">
                    ...
                    <form id="myform" action="${pageContext.request.contextPath}/action/processScheduler.jsp" method="post">
                        <table class="table table-alternatingRow table-border table-columnBorder table-rowBorder">
                            <tr>
                                <th>Time</th>
                                <th>10/10/2014: E130</th>
                                <th>10/10/2014: D304</th>
                                <th>10/11/2014: E130</th>
                                <th>10/11/2014: D304</th>
                            </tr>
                            <%
                                java.sql.Time start = java.sql.Time.valueOf("07:00:00");
                                ArrayList<Session> sessions = sp.getThisYearSessions(2014, "");
                                ...
                                for (int i = 0; i < 11; i++) {
                                    ...
                                    Session current = sp.getSessionByDateAndTime(java.sql.Date.valueOf("2014-10-10"), start, "");
                                    ...
                                    out.print("<option value=\"0\">NO SESSION</option>");
                                    current = sp.getSessionByDateAndTime(java.sql.Date.valueOf("2014-10-10"), start, " ");
                                    for (int j = 0; j < sessions.size(); j++) {
                                        out.print("<option value=\"" + sessions.get(j).getId() + "\"");
                                    ...
                                    out.print("<option value=\"0\">NO SESSION</option>");
                                    current = sp.getSessionByDateAndTime(java.sql.Date.valueOf("2014-10-11"), start, " ");
                                    for (int j = 0; j < sessions.size(); j++) {
                                        out.print("<option value=\"" + sessions.get(j).getId() + "\"");
                                        if ((sessions.get(j).getId() == current.getId()) && (sessions.get(j).getLocation().equals("E130"))) {
                                            out.print(" selected >");
