<%-- 
    Document   : speakerentry-confirm
    Created on : Jul 18, 2013, 9:24:27 AM
    Author     : 162107
--%>
...
<!--[if gt IE 8]><!--> <html class="no-js" lang="en"> <!--<![endif]-->
    <head>
        ...
        <title>Speaker Nomination Confirmation</title>
    ...
    <body id="growler1">
        ...
        <div class="container-fixed largeBottomMargin">
            ...
            <div class="row mediumBottomMargin">
                <h1>Speaker Nomination Confirmation</h1>
            </div>
            <div class="row mediumBottomMargin" style="border:1px dotted #ddd"></div>
            <div class="row">
                <span>The Techtoberfest committee thanks you for your nomination!  You will be contacted for more information if chosen to present.</span>
            </div>
            <div style='margin-bottom:17px;'></div>
            <div class="row">
                <a class='firstlink' href='../../private/employee/nominate.jsp'>Nominate yourself for an additional presentation</a>
