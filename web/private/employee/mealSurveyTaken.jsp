<%-- 
    Document   : mealSurveyTaken
    Created on : Mar 22, 2014, 1:46:48 AM
    Author     : David
--%>
        ...
        <div class="container-fixed largeBottomMargin">
            ...
            <div class="row">
                <ul class="breadcrumb">
                    ...
                    <li class='ieFix'>Already Submitted Survey</li>
                </ul>
            </div>
            <div class="row">
            ...
            <div class="row mediumBottomMargin">
                <h1>Meal Survey Submission</h1>
            </div>
            <div class="row mediumBottomMargin" style="border:1px dotted #ddd"></div>
            <div class="row">
                <span>You've already submitted a survey for the meals and happy hour!</span>
            </div>
