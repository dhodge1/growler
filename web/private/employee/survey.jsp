        ...
        <div class="container-fixed">
            ...
            <div class="row">
				...
				<%
                    ...
                    %>
                    <h2 class = "bordered"><img style="padding-bottom:0;padding-left:0;" src='http://sni-techtoberfest.elasticbeanstalk.com/images/Techtoberfest2013small.png'/><span class="titlespan">Confidential Survey - <% out.print(sp.getSessionByID((Integer.parseInt(sessionId))).getName());%></span></h2>
        ...
        <script>
            $(document).ready(function(){
                $("#send").click(function(event){
                    ...
                    $("#action").attr("action", "../../action/processsurvey.jsp");
                     }
                });
            });
        </script>
