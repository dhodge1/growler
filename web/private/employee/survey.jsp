        ...
        <div class="container-fixed">
            ...
            <div class="row">
				...
				<%
                    ...
                    %>
                    <h2 class = "bordered"><img style="padding-bottom:0;padding-left:0;width:200px;" src='../../images/Techtoberfest2013small.png'/><span class="titlespan">Confidential Survey - <% out.print(sp.getSessionByID((Integer.parseInt(sessionId))).getName());%></span></h2>
