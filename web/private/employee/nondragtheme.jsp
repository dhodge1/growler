            ...
            <div class="row">
				...
				<%
                    ...
                    if (themes == null || themes.size() == 0) {
                        out.print("<h2 class=bordered><img style=\"padding-bottom:0;padding-left:0;width:200px;\" src='../../images/Techtoberfest2013small.png'/><span class=\"titlespan\">Themes - Click To Order Themes</span></h2>");
