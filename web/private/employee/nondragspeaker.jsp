            ...
            <div class="row">
				...
				<%
                    ...
                    if (speakers == null || speakers.size() == 0) {
                        out.print("<h2 class=bordered><img style=\"padding-bottom:0\" src='../images/Techtoberfest2013small.png'/><span class=\"titlespan\">Speakers - Click To Order Speakers</span></h2>");
                    } else { //If we got speakers, we let the user see them
                        response.sendRedirect("../view/speaker.jsp");
                        out.print("<h2 class=bordered><img style=\"padding-bottom:0\" src='../images/Techtoberfest2013small.png'/><span class=\"titlespan\">Your Speaker Ranks</span></h2>");
                    }
                %>
