...
<!--[if gt IE 8]><!--> <html class="no-js" lang="en"> <!--<![endif]-->
    ...
    <body id="growler1">
        ...
        <div class="container-fixed mediumBottomMargin">
            ...
            <div class="row">
                <h2 class="bordered"><img id="logo" style="padding-left:0;padding-bottom:0;" src='http://growler-dev.elasticbeanstalk.com/images/Techtoberfest2013small.png'/><span class="titlespan nowrap">Help By Topic</span><span class="pullRight"><a href='Techtoberfest_HelpDocumentation_2013.pdf' target="blank">View as PDF</a></span></h2>
            </div>
            <div class="row">
