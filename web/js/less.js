...
function (a, b) {
    ...
    v === b && (v = exports, w = c("./tree"), v.mode = "node"), v.Parser = function (a) {
        ...
        return t.prototype = new Error, t.prototype.constructor = t, this.env = a = a || {}, this.optimization = "optimization" in this.env ? this.env.optimization : 1, F = {
            ...
            parsers: G = {
                primary: function () {
                    for (var a, b = this.mixin, c = J, d = []; D;) if (a = this.extendRule() || b.definition() || this.rule() || this.ruleset() || b.call() || this.comment() || this.directive()) d.push(a);
                    else if (!c(/^[\s\n]+/) && !c(/^;+/)) break;
                    return d
                },
                comment: function () {
                ...
                mixin: {
                    call: function () {
                        ...
                        if ("." === l || "#" === l) {
                            ...
                            return j("(") && (k = this.args(!0).args, m(")")), G.important() && (n = !0), c && (j(";") || p("}")) ? new w.mixin.Call(c, k, o, a.currentFileInfo, n) : (e(), void 0)
                        }
                    },
                    args: function (a) {
                        for (var b, c, d, e, f, g, h = F.parsers, k = h.entities, m = {
                            ...
                            var r = null;
                            if (a ? 1 == g.value.length && (r = g.value[0]) : r = g, r && r instanceof w.Variable) if (j(":")) o.length > 0 && (b && n("Cannot mix ; and , as delimiter types"), c = !0), f = l(h.expression), e = d = r.name;
                            else {
                                if (!a && i(/^\.{3}/)) {
                                    m.variadic = !0, j(";") && !b && (b = !0), (b ? p : q).push({
                                        name: g.name,
                ...
                selector: function (b) {
                    for (var c, d, e, f, g, h, i, j = x, k = J;
                    (b && (g = this.extend()) || b && (h = k(/^when/)) || (f = this.element())) && (h ? i = l(this.conditions, "expected condition") : i ? n("CSS guard can only be used at the end of selector") : g ? d ? d.push(g) : d = [g] : (d && n("Extend can only be used at the end of selector"), e = u.charAt(x), c ? c.push(f) : c = [f], f = null), "{" !== e && "}" !== e && ";" !== e && "," !== e && ")" !== e););
                ...
                mediaFeatures: function () {
                    ...
                    if (a = this.mediaFeature()) {
                        if (c.push(a), !j(",")) break
                    } else if (a = b.variable(), a && (c.push(a), !j(","))) break;
                    while (a);
                ...
                expression: function () {
                    var a, b, c = [];
                    do a = this.addition() || this.entity(), a && (c.push(a), o(/^\/[\/*]/) || (b = j("/"), b && c.push(new w.Anonymous(b))));
                    while (a);
        ...
        a.mixin = {}, a.mixin.Call = function (b, c, d, e, f) {
            ...
            eval: function (b) {
                ...
                for (e = this.arguments && this.arguments.map(function (a) {
                    ...
                    for (q.reset(), g = 0; g < o.length; g++) if (l = o[g], !l.matchIfDefault || l.matchIfDefaultValue == (1 == o.length)) try {
                    ...
                    if (n) {
                        if (!this.currentFileInfo || !this.currentFileInfo.reference) for (f = 0; f < m.length; f++) k = m[f], k.markReferenced && k.markReferenced();
                        return m
                    }
                }
                throw j ? {
        ...
        a.Ruleset = function (a, b, c) {
            ...
            eval: function (b) {
                ...
                if (k.shift(), l.shift(), b.mediaBlocks) for (e = o; e < b.mediaBlocks.length; e++) b.mediaBlocks[e].bubbleSelectors(c);
                return j
            },
            ...
            joinSelector: function (b, c, d) {
                ...
                if (h) {
                    for (r = [], i = [
                        ...
                        for (s = [], r.length > 0 && this.mergeElementsOnToSelectors(r, i), f = 0; f < i.length; f++) if (k = i[f], 0 === c.length) k.length > 0 && (k[0].elements = k[0].elements.slice(0), k[0].elements.push(new a.Element(j.combinator, "", 0, j.index, j.currentFileInfo))), s.push(k);
        ...
        a.Selector = function (a, b, c, d, e, f) {
            ...
            match: function (a) {
                ...
                for (d = 0; c > d; d++) if (e[d].value !== b[d]) return 0;
                return c
            },
            eval: function (a) {
