...
public class GrowlerQueries {
    ...
    /**
     * @return Used for selecting user suggested speakers(so they can be
     * ranked), user story 10337 & 10338
     */
    ...
    /**
     * @return Used for selecting user suggested themes (so they can be ranked),
     * user story 10333
     */
    ...
    /**
     * @return returns the first and last names of the speaker, as well as the
     * id
     */
    ...
    /**
     * @return Used for displaying the number of times a speaker was ranked in
     * the past, user story 10365
     */
    ...
    /**
     * @return insert statement into speakers, user story 10336 & user story
     * 10348
     */
    ...
    /**
     * @return insert statement into isolated_theme_ranking table, user story
     * 10332 & 10359
     */
    ...
    /**
     *
     * @return an insert statement into the theme_ranking table (theme_id,
     * user_id, ranking)
     */
    ...
    /**
     * @return updates a theme to be visible, so it is "promoted", user story
     * 10360
     */
    ...
    /**
     * @return updates a speaker to be visible, so it is "promoted", user story
     * 10361
     */
    ...
    /**
     *
     * @return Returns the id, name and average ranking given by users (highest
     * to lowest)
     */
